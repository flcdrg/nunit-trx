	...
	public class ConsoleUi
	{
		...
		public int Execute( ConsoleOptions options )
		{
            ...
            using (TestRunner testRunner = new DefaultTestRunnerFactory().MakeTestRunner(package))
			{
                ...
                var collector = CollectorFactory( options, errorWriter, outWriter );
	    ...
	    protected virtual EventCollector CollectorFactory( ConsoleOptions options, TextWriter errorWriter, TextWriter outWriter )
	    {
	        return new EventCollector( options, outWriter, errorWriter );
	    }
        ...
        protected virtual string CreateXmlOutput( TestResult result )
        {
